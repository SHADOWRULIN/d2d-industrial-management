...
const styles = {
  ...
  card: { background: "rgba(30, 30, 30, 0.6)", backdropFilter: "blur(15px)", padding: "40px", borderRadius: "20px", width: "500px", border: "1px solid rgba(255,255,255,0.1)", textAlign: "center", color: "white" },
  ...
  input: { padding: "12px", borderRadius: "8px", border: "none", fontSize: "16px", background: "rgba(0, 0, 0, 1)", color: "white" },
  stars: { display: "flex", gap: "5px", cursor: "pointer", fontSize: "35px", justifyContent: "center" },
